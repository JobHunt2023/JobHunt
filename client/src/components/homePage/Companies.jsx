...
export const Companies = () => {
  return (
    <>
<div class="py-10 relative bg-bg-white sm:py-16 lg:py-24 lg:pt-36">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 text-center  ">
        <div class="max-w-2xl mx-auto text-center">
            <h2 class="text-5xl pb-12 font-semibold text-dark-color sm:text-4xl sm:leading-tight">Trusted by world class companies
            </h2>
        </div>

        <div class=" grid items-center max-w-4xl grid-cols-2 gap-4 mx-auto mt-12 md:mt-20 md:grid-cols-4  ">
            <div class="bg-bg-white h-12 flex shadow-lg items-center justify-center">
       ...
       <Link to='/job'>
       <p class="hover:bg-dark-color/50 hover:text-dark-btn-txt-color mt-10 text-base text-center text-dark-color md:mt-20 p-6 py-3 border w-72 border-datext-dark-color rounded-full mx-auto">
