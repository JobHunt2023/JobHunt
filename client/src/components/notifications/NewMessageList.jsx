...
export const NewMessageList = () => {
  return (
    <>
     <div class="p-3 flex items-center justify-between border-t cursor-pointer hover:bg-light-color/25">
          <div class="flex items-center">
            ...
            <div class="ml-2 flex flex-col">
              ...
              <div class="leading-snug text-xs text-dark-color/90">sent you a message</div>
            </div>
          </div>
