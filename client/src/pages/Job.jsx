        ...
        <div className="flex flex-col items-center justify-center min-h-screen ">
          ...
          <div className="container  m-4">
            <div className=" w-3/4 mx-auto grid gap-4 grid-cols-1">
              ...
              <div className="flex flex-col bg-bg-white top-0 ">
                ...
                {/* key={product.id}  */}
                  <div className=" border  rounded-2xl p-4">
                    <div className="flex-none sm:flex">
                      <div className=" relative h-32 w-32   sm:mb-0 mb-3">
                        <img
                          src="https://plus.unsplash.com/premium_photo-1682002135678-87b8a2fdde50?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8TE9HT3xlbnwwfHwwfHx8MA%3D%3D"
                          alt="aji"
                          className=" w-32 h-32 object-cover rounded-2xl"
                        />
                      </div>
