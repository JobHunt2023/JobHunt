...
function NewsFeed() {
  return (
    <>
      <div
        class="border text-card-foreground max-w-xl mx-auto mt-8 p-4 bg-white shadow-md rounded-md"
        data-v0-t="card"
      >
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            ...
            <div>
              ...
              <p class="text-sm text-gray-500">Dec 13, 2023</p>
            </div>
          </div>
        ...
        <p class="mt-4 text-gray-800">
          This is a placeholder text for your post content. Whatever you'd like
          to say goes here.
